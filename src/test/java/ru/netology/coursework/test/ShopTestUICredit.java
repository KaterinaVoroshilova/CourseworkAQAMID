...
public class ShopTestUICredit {
    ...
    void shouldNotPayWithCVCAs4Numbers() {
        ...
        credit.putData(DataHelper.getApprovedCardNumber(), DataHelper.generateMonth(), DataHelper.generateYear(), DataHelper.getValidHolder(), cvv4);
        credit.getCVVAssert(expectedCVV);
    }
